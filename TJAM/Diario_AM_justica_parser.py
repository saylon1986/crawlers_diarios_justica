	...
	for b in tqdm(range(len(pastas))):
		...
		for a in range(len(arquivos)):
			...
			with fitz.open(nome) as pdf:
			    ...
			    # print()
			    # print("esse pdf tem",len(df_textos_paginas),"páginas")
			    # print()
